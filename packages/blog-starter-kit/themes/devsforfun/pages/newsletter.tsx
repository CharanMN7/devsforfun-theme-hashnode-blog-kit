...
const Newsletter = (props: Props) => {
  const { recent3Posts, publication: publicationProps, currentMenuId } = props;

  const publication = publicationProps;
  ...
  return (
    <AppProvider publication={publication}>
      ...
      <div className="blog-page-area mx-auto min-h-screen px-4 pb-8 pt-20 md:px-10 md:pt-20 dark:bg-black">
